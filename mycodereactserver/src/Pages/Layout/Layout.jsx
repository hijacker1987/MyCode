                            ...
                            {location.pathname !== uLogin && location.pathname !== uReg && (
                                <ButtonRowButtonContainer style={{ marginLeft: "17%" }}>
                                    ...
                                    <ButtonColumnContainer style={{ marginTop: "-6%", marginLeft: "147%" }}>
                                        ...
                                        <button class="gsi-material-button" onClick={() => handleOnExternalLogin("Google")} style={{ marginTop: "-10%", marginLeft: "8%" }}>
                                            <div class="gsi-material-button-content-wrapper">
                                                <span class="gsi-material-button-icon" style={{ marginLeft: "-13%" }}></span>
                                                <span class="gsi-material-button-contents">Google</span>
                                            </div>
                                        </button>
                                        <button class="loginBtn--facebook" onClick={() => handleOnExternalLogin("Facebook")} style={{ width: "120px", height: "40px", marginLeft: "8%" }}>
                                            <div class="gsi-material-button-content-wrapper">
                                        ...
                                        <button type="button" onClick={() => handleOnExternalLogin("GitHub")} style={{ width: "120px", height: "40px", marginLeft: "8%", cursor: "pointer" }} class="py-2 px-4 max-w-md flex justify-center items-center bg-gray-600 hover:bg-gray-700 focus:ring-gray-500 focus:ring-offset-gray-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg">
